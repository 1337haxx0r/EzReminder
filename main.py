...
from tkinter import messagebox, Listbox, Toplevel, Menu, Label, Entry, Button, PhotoImage
...
print("creating gui")
icon_path = os.path.join(base_path, "icon", config['app']['icon'])
...
calendar_entry = ttk.DateEntry(root, style='success.TCalendar', width=10, dateformat="%Y-%m-%d")  # Create a calendar widget
...
def on_closing():
    pygame.mixer.quit()  # Properly quit the pygame mixer
